...
public class Main extends Application
{
   ...
   Stage theStage;
   ShopPane mainPane = new ShopPane();
   ...
   //creating the shop
      ...
      empty3.getChildren().add(mainPane);
      empty3.getChildren().add(new Label("                   "));   
      ...
      money = new Text("Current Funds: " + Player.getInstance().getMoney());
   }
   ...
   public class ButtonListener implements EventHandler<ActionEvent>
   {
      public void handle(ActionEvent e)      
      {
         ...
         {
            setShop(theStage);
            mainPane.updateMoney(p.getMoney());
         }
         if(e.getSource() == back)
         {
            setMenu(theStage);    
